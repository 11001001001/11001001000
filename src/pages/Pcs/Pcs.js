...
const Pcs = () => {
    ...
    const personalArray = [1246220475, 1337794153, 461562982, 1113062725, 5159615262, 5325888626, 5558141720, 1472252426, 964159618, 1695095534, 1231769536, 6378397748, 1364261657, 597552910, 1641779424];
